...
//20 April 2012 (SA) Ticket #794: add print button to description section on tickets
  ...
  class SystemModule extends Module {
    ...
    function defineRoutes(&$router) {
      ...
      //BOF: task 05 | AD
      $router->map('view_projects_info', 'view-projects-info', array('controller' => 'dashboard', 'action' => 'view_projects_info'));
      //EOF: task 05 | AD
      $router->map('recent_pages', 'recent-pages', array('controller' => 'dashboard', 'action' => 'recent_pages'));
      $router->map('attachments_list', 'attachments-list', array('controller' => 'dashboard', 'action' => 'attachments_list'));
	  $router->map('reminders_list', 'reminders-list', array('controller' => 'dashboard', 'action' => 'reminders_list'));
	  $router->map('fyi_read_all', 'fyireadall', array('controller' => 'dashboard', 'action' => 'fyi_read_all'));
	  $router->map('goto_home_tab', 'gotohometab', array('controller' => 'dashboard', 'action' => 'goto_home_tab'));
          $router->map('my_tickets', 'mytickets', array('controller' => 'dashboard', 'action' => 'my_tickets'));
          $router->map('my_subscribed_tickets', 'mysubscribedtickets', array('controller' => 'dashboard', 'action' => 'my_subscribed_tickets'));
      //BOF:mod 20111019 #448
      $router->map('project_object_action_request_completed', 'projects/:project_id/actionrequestcompleted', array('controller' => 'dashboard', 'action' => 'action_request_completed'), array('project_id' => '\d+'));
      $router->map('project_object_fyi_read', 'projects/:project_id/fyiread', array('controller' => 'dashboard', 'action' => 'fyi_read'), array('project_id' => '\d+'));
      //EOF:mod 20111019 #448
      //BOF:mod 20120106
      $router->map('render_comments', 'rendercomments', array('controller' => 'dashboard', 'action' => 'render_comments'));
      $router->map('assigned_action_request', 'assigned_action_request', array('controller' => 'dashboard', 'action' => 'assigned_action_request'));
      //EOF:mod 20120106
	  //BOF:mod 20120906
	  $router->map('collection', 'collection', array('controller' => 'dashboard', 'action' => 'get_collection'));
	  //EOF:mod 20120906
      ...
      //BOF: task 04 | AD
      $router->map('project_manage_milestone_categories', 'projects/:project_id/manage-milestone-categories', array('controller' => 'project', 'action' => 'manage_milestone_categories'), array('project_id' => '\d+'));
      //EOFL task 04 | AD
      //$router->map('project_recent_pages_1', 'projects/:project_id/recent-pages-1', array('controller' => 'project', 'action' => 'recent_pages_1'), array('project_id' => '\d+'));
      ...
      //BOF: task 01 | AD
      $router->map('project_user_view_allocations', 'projects/:project_id/user/:user_id/view-allocations', array('controller' => 'project_people', 'action' => 'view_user_allocations'), array('project_id' => '\d+', 'user_id' => '\d+'));
      $router->map('project_user_assigned_milestones', 'projects/:project_id/user/:user_id/assigned-milestones', array('controller' => 'project_people', 'action' => 'view_assigned_milestones'), array('project_id' => '\d+', 'user_id' => '\d+'));
      $router->map('project_user_today_page', 'projects/:project_id/user/:user_id/today-page', array('controller' => 'project_people', 'action' => 'view_today_page'), array('project_id' => '\d+', 'user_id' => '\d+'));
	  $router->map('user_assigned_milestones', 'assigned-milestones-all', array('controller' => 'people', 'action' => 'view_assigned_milestones_all_projects'), array('project_id' => '\d+'));
	  $router->map('user_today_page', 'today-page-all', array('controller' => 'people', 'action' => 'view_today_page_all_projects'));
      //EOF: task 01 | AD
      $router->map('star_user_projects_page', 'projects/:project_id/users/:user_id/star-user-projects-page', array('controller' => 'project_people', 'action' => 'star_user_projects_page'), array('project_id' => '\d+', 'user_id' => '\d+'));
      $router->map('unstar_user_projects_page', 'projects/:project_id/users/:user_id/unstar-user-projects-page', array('controller' => 'project_people', 'action' => 'unstar_user_projects_page'), array('project_id' => '\d+', 'user_id' => '\d+'));
      $router->map('star_user_tickets_page', 'projects/:project_id/users/:user_id/star-user-tickets-page', array('controller' => 'project_people', 'action' => 'star_user_tickets_page'), array('project_id' => '\d+', 'user_id' => '\d+'));
      $router->map('unstar_user_tickets_page', 'projects/:project_id/users/:user_id/unstar-user-tickets-page', array('controller' => 'project_people', 'action' => 'unstar_user_tickets_page'), array('project_id' => '\d+', 'user_id' => '\d+'));
      ...
      $router->map('project_object_delete', 'projects/:project_id/objects/:object_id/delete', array('controller' => 'project_objects', 'action' => 'delete'), array('project_id' => '\d+', 'object_id' => '\d+'));
      ...
      $router->map('print_description', 'projects/:project_id/objects/:object_id/print_description', array('controller' => 'project_objects', 'action' => 'print_description'), array('project_id' => '\d+', 'object_id' => '\d+'));
	  //BOF:mod 20121010
	  $router->map('show_description', 'projects/:project_id/objects/:object_id/versions/:version_id/show_description', array('controller' => 'project_objects', 'action' => 'show_description'), array('project_id' => '\d+', 'object_id' => '\d+', 'version_id' => '\d+')  );
	  $router->map('print_old_versions', 'projects/:project_id/objects/:object_id/versions/:version_id/print_old_versions', array('controller' => 'project_objects', 'action' => 'print_old_versions'), array('project_id' => '\d+', 'object_id' => '\d+', 'version_id' => '\d+')  );
	  //EOF:mod 20121010
	  //BOF:mod 20121116
	  $router->map('project_object_convert_to_ticket', 'projects/:project_id/objects/:object_id/converttoticket', array('controller' => 'project_objects', 'action' => 'convert_object_to_ticket'), array('project_id' => '\d+', 'object_id' => '\d+'));
	  $router->map('project_object_convert_to_milestone', 'projects/:project_id/objects/:object_id/converttomilestone', array('controller' => 'project_objects', 'action' => 'convert_object_to_milestone'), array('project_id' => '\d+', 'object_id' => '\d+'));
	  $router->map('project_object_convert_to_page', 'projects/:project_id/objects/:object_id/converttopage', array('controller' => 'project_objects', 'action' => 'convert_object_to_page'), array('project_id' => '\d+', 'object_id' => '\d+'));
	  //EOF:mod 20121116
      ...
      $router->map('custom_tabs_manager', 'custom-tabs-manager', array('controller' => 'widgets', 'action' => 'custom_tabs_manager'));
      //BOF:mod 20110715 ticketid246
      //BOF:mod 20111220
      $router->map('image_uploader', 'image-uploader', array('controller' => 'widgets', 'action' => 'image_uploader'));
      //EOF:mod 20111220

  ...
  class UsersController extends CompaniesController {
    ...
    function edit() {
      ...
      if($this->request->isApiCall() && $this->request->isSubmitted()) {
        ...
        $config_options = array('title', 'phone_work', 'phone_mobile', 'im_type', 'im_value', 'format_date', 'format_time', 'time_timezone', 'time_dst', 'time_first_week_day', 'visual_editor', 'theme', 'generate_daily_mail');
        ...
        if($save && !is_error($save)) {
          ...
          foreach($config_options as $config_option) {
      	    if($config_option == 'time_dst' || $config_option == 'visual_editor' || $config_option=='generate_daily_mail') {

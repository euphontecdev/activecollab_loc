<?php
  ...
  /*
  //EOF:Mod 20120711
  function search_index_search($search_for, $type, $user, $page = 1, $per_page = 30, $search_object_type = '', $search_under_project_id = '') {
  	return call_user_func_array(array(SEARCH_ENGINE, 'search'), array($search_for, $type, $user, $page, $per_page, $search_object_type, $search_under_project_id));
  } // search_index_search
  //BOF:mod 20120711 
  */
  function search_index_search($search_for, $type, $user, $page = 1, $per_page = 30, $search_object_type = '', $search_under_project_id = '', $datesort = '') {
  	return call_user_func_array(array(SEARCH_ENGINE, 'search'), array($search_for, $type, $user, $page, $per_page, $search_object_type, $search_under_project_id, $datesort));
  } // search_index_search
  //EOF:Mod 20120711
  
  //BOF:mod 20120822
  function search_attachments($search_for, $user, $page = 1, $per_page = 30, $search_object_type = '', $search_under_project_id = '', $datesort = '') {
  	return call_user_func_array(array(SEARCH_ENGINE, 'search_attachments'), array($search_for, $user, $page, $per_page, $search_object_type, $search_under_project_id, $datesort));
  } // search_index_search
  //EOF:mod 20120822
  /**

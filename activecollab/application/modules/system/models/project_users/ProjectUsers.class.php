<?php
  ...
  class ProjectUsers extends BaseProjectUsers {
    ...
    function findUsersByProject($project) {
      ...
      return Users::findBySQL("SELECT $users_table.* FROM $users_table, $project_users_table WHERE $project_users_table.project_id = ? AND $project_users_table.user_id = $users_table.id ORDER BY CONCAT($users_table.first_name, $users_table.last_name, $users_table.email)", array($project->getId()));
    } // findUsersByProject

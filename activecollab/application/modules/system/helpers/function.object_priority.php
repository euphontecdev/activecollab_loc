  ...
  function smarty_function_object_priority($params, &$smarty) {
    ...
    switch($object->getPriority()) {
      ...
      case PRIORITY_URGENT:
        $icon_url = get_image_url('icons/priority/urgent.png');
        $icon_tip = lang('Urgent Priority');
        break;
	  //EOF:mod 20121107
      ...
      case PRIORITY_ONGOING:
        $icon_url = get_image_url('icons/priority/ongoing.png');
        $icon_tip = lang('Ongoing Priority');
        break;
	  //BOF:mod 20121107
	  */
	  //EOF:mod 20121107
      case PRIORITY_HOLD:
        $icon_url = get_image_url('icons/priority/hold.png');
        $icon_tip = lang('Hold Priority');
        break;
    } // switch

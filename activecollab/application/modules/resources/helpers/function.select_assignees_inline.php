<?php
  ...
  function smarty_function_select_assignees_inline($params, &$smarty) {
    ...
    //BOF:mod
	$show_only_names = array_var($params, 'show_only_names', false);
    $set_fyi_actionrequest = ($show_only_names ? false : true);
    $object = array_var($params, 'object');
    /*if ($object->permission_name=='ticket'){
		$set_fyi_actionrequest = true;
		$ticket_id = array_var($params, 'ticket_id');
		if (!empty($ticket_id)){
    ...
    $smarty->assign(array(
      ...
      //BOF:mod
      'set_fyi_actionrequest'				  => $set_fyi_actionrequest,

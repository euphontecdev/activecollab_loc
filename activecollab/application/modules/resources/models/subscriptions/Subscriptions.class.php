<?php
  ...
  class Subscriptions extends BaseSubscriptions {
    ...
    function findSubscribersByParent($parent) {
      ...
      //BOF:mod 20121105
	  */
	  return Users::findBySQL("SELECT $users_table.* FROM $users_table, $subscriptions_table WHERE $users_table.id = $subscriptions_table.user_id AND $subscriptions_table.parent_id = ? order by first_name, last_name", array($parent->getId()));
	  //EOF:mod 20121105

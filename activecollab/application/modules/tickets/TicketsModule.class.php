...
/*{*27 March 2012 Ticket #770: modify Print function for Pages in AC (SA)*}*/
  ...
  class TicketsModule extends Module {
    ...
    function defineRoutes(&$router) {
      ...
      $router->map('project_tickets_categories', 'projects/:project_id/tickets/categories', array('controller' => 'tickets', 'action' => 'categories'), array('project_id' => '\d+'));
	  ...
	  $router->map('project_ticket_change_priority', 'projects/:project_id/tickets/:ticket_id/changepriority', array('controller' => 'tickets', 'action' => 'change_priority'), array('project_id' => '\d+', 'ticket_id' => '\d+'));
    } // defineRoutes

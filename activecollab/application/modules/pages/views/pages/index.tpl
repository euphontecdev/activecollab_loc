  ...
  {if is_foreachable($grouped_pages)}
    ...
    {foreach from=$pages item=page}
      ...
      {else}
        <td class="name">
          {object_link object=$page}
          <span class="block details">{lang version=$page->getRevisionNum()}Version #:version by{/lang} {user_link user=$page->getLatestVersionBy()}. {lang}Initial version by{/lang} {user_link user=$page->getCreatedBy()}</span>
        </td>

  ...
  <div class="resources">
    ...
    <div class="resource object_comments" id="comments">
      ...
      {*if $pagination->getLastPage() > 1}
        ...
        {/if*}
		{if $show_all=='1'}
		{object_comments_all object=$active_page show_header=no}
		{else}

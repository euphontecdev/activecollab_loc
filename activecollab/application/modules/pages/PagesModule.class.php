...
/* 5/5/2012 (SA) Ticket #825: limit number of versions visible*/
  ...
  class PagesModule extends Module {
    ...
    function defineRoutes(&$router) {
      ...
      $router->map('project_pages_categories', 'projects/:project_id/pages/categories', array('controller' => 'pages', 'action' => 'categories'), array('project_id' => '\d+'));
      ...
      $router->map('project_page_version_showall', 'projects/:project_id/pages/:page_id/show_all_versions', array('controller' => 'pages', 'action' => 'show_all_versions'), array('project_id' => '\d+', 'page_id' => '\d+'));
	  //BOF:mod 20120806
	  $router->map('goto_user_task_page', 'projects/:project_id/gotousertaskpage', array('controller' => 'pages', 'action' => 'goto_tasks_page_for_user'), array('project_id' => '\d+'));
	  //EOF:mod 20120806
    } // defineRoutes

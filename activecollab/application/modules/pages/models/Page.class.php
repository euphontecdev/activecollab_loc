<?php
  ...
  class Page extends ProjectObject {
    ...
    /**
     * Return user who create latest page version
     *
     * @return User
     */
    function getLatestVersionBy() {
      $latest_version = $this->getLatestVersion();
      
      if(instance_of($latest_version, 'PageVersion')) {
        return $latest_version->getCreatedBy();
      } else {
    ...
    function createVersion($by) {
      ...
      $version->setCreatedOn(new DateTimeValue());

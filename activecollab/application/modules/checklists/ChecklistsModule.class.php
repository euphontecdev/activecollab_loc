<?php
  ...
  class ChecklistsModule extends Module {
    ...
    function defineRoutes(&$router) {
      ...
      $router->map('project_checklist_open_tasks', 'projects/:project_id/checklists/:checklist_id/opentasks', array('controller' => 'checklists', 'action' => 'opentasks'), array('project_id' => '\d+', 'checklist_id' => '\d+'));
    } // defineRoutes

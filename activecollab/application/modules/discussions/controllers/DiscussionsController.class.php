<?php
  ...
  class DiscussionsController extends ProjectController {
     ...
     * @var array
     */
    var $api_actions = array('index', 'view', 'add', 'edit', 'categories');
    ...
    function index() {
      if($this->request->isApiCall()) {
        if($this->active_category->isLoaded()) {
          $this->serveData(Discussions::findByCategory($this->active_category, STATE_VISIBLE, $this->logged_user->getVisibility()), 'discussions');
        } else {
        ...
        */
        /*
        $selected_department_id = (integer) $this->request->get('category_id');
        ...
        $this->smarty->assign(array(
          ...
          'departments' => $this->active_project->getDepartments(), 
          'selected_department_id' => $selected_department_id
        ));*/
      	$selected_category_id = $_GET['category_id'];
      	$departments = Discussions::getItemsByDepartment($this->active_project->getId(), new Discussion());
      	$this->smarty->assign(array(
      							'departments' => $departments, 
      							'selected_category_id' => $selected_category_id, 
      							'categories_url' => assemble_url('project_manage_milestone_categories', array('project_id' => $this->active_project->getId())), 
								'can_manage_categories' => $this->logged_user->isProjectLeader($this->active_project) || $this->logged_user->isProjectManager(),      							
		  						));
      } // if
    } // index
    ...
    function view() {
      ...
      if($this->request->isApiCall()) {
        ...
        $this->smarty->assign(array(
          ...
          //BOF:mod 20110615
          'object_id' => $this->active_discussion->getId()
          //EOF:mod 20110615
        ));
      } // if
    } // view

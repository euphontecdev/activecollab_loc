...
{*}{if $active_discussion->isNew()}{*}
  {wrap field=notify_users}
    ...
    {select_assignees_inline name=notify_users value=$notify_users project=$active_project object=$active_discussion}
    <div class="clear"></div>
  {/wrap}
{*}{/if}{*}  
</div>
...
<div class="form_right_col">
  ...
  {wrap field=category}
	...
	{select_departments name='discussion[departments][]' object=$active_discussion project=$active_project}
  {/wrap}

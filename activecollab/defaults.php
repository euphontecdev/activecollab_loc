<?php
  ...
  // on rare occasions, regex for 'clickable' modifier returns
  // and sometimes the feature to be turned off
  if (!defined('MAKE_LINKS_CLICKABLE')) {
  	define('MAKE_LINKS_CLICKABLE', true);
  } // if
  ...
  if(!defined('RESIZE_SMALLER_THAN')) {
    ...
    define('RESIZE_SMALLER_THAN', 12582912);
  } // if
  ...
  // to fix permission after move_uploaded_file. Value of contstant should be new permission if fix is needed
  if (!defined('FIX_UPLOAD_PERMISSION')) {
    define('FIX_UPLOAD_PERMISSION', false);
  } // if
  ...
  if (!defined('CACHE_FILE_BACKEND_PERMISSION')) {
	  define('CACHE_FILE_BACKEND_PERMISSION', false);
  } // if
  ...
  if (!defined('MAX_SUBSCRIBERS_COUNT')) {
    define('MAX_SUBSCRIBERS_COUNT', 50);
  } // if

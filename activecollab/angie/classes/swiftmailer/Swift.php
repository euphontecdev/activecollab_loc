...
class Swift
{
   ...
   */
  function send(&$message, $recipients, $from, $modified_subject=array())
  {
   ...
   * @return int The number of successful recipients
   */
  function batchSend(&$message, &$to, $from, $modified_subject = array())
  {
    if (!is_a($message, "Swift_Message"))
    {
    ...
    return $batch->send($message, $to, $from, $modified_subject);
  }
}

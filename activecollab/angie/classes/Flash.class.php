<?php
  ...
  * @return null
  */
  function flash_success($message, $replacements = null, $not_lang = false, $skip_custom_replacement = false) {
    $set = $not_lang ? $message : lang($message, $replacements, true, null, $skip_custom_replacement);
  ...
  * @return null
  */
  function flash_error($message, $replacements = null, $not_lang = false, $skip_custom_replacement = false) {
    $set = $not_lang ? $message : lang($message, $replacements, true, null, $skip_custom_replacement);
    flash_add('error', $set);
  } // flash_error

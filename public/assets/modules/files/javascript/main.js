  ...
  upload : function() {
    ...
    */
    ...
    var start_upload = function () {
      ...
      $("input[name='assignee[flag_actionrequest][]']:checked").each(function () {
        upload_form.append("<input type='hidden' name='assignee[flag_actionrequest][]' class='people' value='" + $(this).val() + "' />");       
      });
      $("input[name='assignee[flag_fyi][]']:checked").each(function () {
        upload_form.append("<input type='hidden' name='assignee[flag_fyi][]' class='people' value='" + $(this).val() + "' />");       
      });
      $("input[name='assignee[flag_email][]']:checked").each(function () {
        upload_form.append("<input type='hidden' name='assignee[flag_email][]' class='people' value='" + $(this).val() + "' />");       
      });
    ...
    $(document).ready(function() {
      ...
      $('#upload_files').click(function () {
		if ($("#fileMilestone").val()==''){
			if ($('label[for="fileMilestone"]').parent().find('p.errorField').length==0){
				$('label[for="fileMilestone"]').parent().addClass('focused').addClass('error').prepend('<p class="errorField"><strong>Required</strong></p>');
			}
			return false;
		}
        submit_multiupload_form();

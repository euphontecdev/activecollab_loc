...
App.lang = function(content, params) {
  ...
  //BOF: mod
  if (translation.indexOf('Projects')!=-1){
  	translation = translation.replace(/Projects/g, 'Teams');
  }
  if (translation.indexOf('projects')!=-1){
  	translation = translation.replace(/projects/g, 'teams');
  }
  
  if (translation.indexOf('Project')!=-1){
  	translation = translation.replace(/Project/g, 'Team');
  }
  if (translation.indexOf('project')!=-1){
  	translation = translation.replace(/project/g, 'team');
  }
  
  if (translation.indexOf('Milestones')!=-1){
  	translation = translation.replace(/Milestones/g, 'Projects');
  }
  if (translation.indexOf('Milestone')!=-1){
  	translation = translation.replace(/Milestone/g, 'Project');
  }
